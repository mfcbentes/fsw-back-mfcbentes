package br.com.mfcbentes.fullstackweek.domain;
...
public class Pessoa {
	...
	@ManyToOne
	@JoinColumn(name="codigo_grp_prioritario")
	...
	public GrupoPrioritario getGrupo() {
		return grupo;
	}
	public void setGrupo(GrupoPrioritario grupo) {
		this.grupo = grupo;
	}
